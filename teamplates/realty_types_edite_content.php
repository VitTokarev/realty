...
<head>
    ...
    <title>Добавление объекта недвижимости</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Редактирование типа объекта недвижимости</h1>

                        <form method="POST">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Новый тип объекта недвижимости:
                                </div>
                                <input class="form-control" type="text" name="type" value="<?= $realty_type['type']?>">
                            </div>
                            <p>
                                <input class="btn btn-success" type="submit" name="edite_type" value="Изменить">
